...
a = AudioSegment.from_mp3(currDir+"/audio/sentence1.mp3")
b = AudioSegment.from_mp3(currDir+"/audio/sentence2.mp3")
...
output.export(currDir+"/audio/conversation1.mp3", format="mp3")
